...
export default function Home() {
  ...
  const generateImageTxt = async () => {
    const options = {
      method: 'GET',
      headers: {
        accept: 'application/json',
        authorization: 'Bearer key-1b3FJjwHY1kn07pIpu32qK1CdXPSUFhRjSpYHvFWd5ITZPFpvPrruWybtkxuA4NlpjGUowCa3X7b9bpOUt8m80Vyx36Rq196'
      }
    };
    
    fetch('https://api.getimg.ai/v1/models', options)
    ...
    <main className="container flex flex-col items-center justify-between overflow-x-hidden">
      ...
      <div className='relative w-full flex flex-col	place-items-center mt-20 mb-28 px-4 z-20'>
        <div className='relative w-full'>
          <h1 className='mb-4 font-bold text-lg'>PLAYGROUND : <br></br> TEXT TO IMAGE</h1>
